...
function buildEduDropdown(){
  ...
  Object.keys(TRACKS).forEach(id => {
    ...
    html += `<a href="course.html?track=${id}">${t.icon || '<svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bookGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3B82F6" /><stop offset="100%" stop-color="#1D4ED8" /></linearGradient><linearGradient id="bookGlow" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#60A5FA" /><stop offset="100%" stop-color="#93C5FD" /></linearGradient></defs><path d="M4 19.5C4 18.1193 5.11929 17 6.5 17H20V4H6.5C5.11929 4 4 5.11929 4 6.5V19.5Z" stroke="url(#bookGrad)" stroke-width="1.8" fill="url(#bookGrad)" fill-opacity="0.15" stroke-linejoin="round"/><path d="M6.5 17C5.11929 17 4 18.1193 4 19.5C4 20.8807 5.11929 22 6.5 22H20V17H6.5Z" stroke="url(#bookGrad)" stroke-width="1.8" stroke-linejoin="round"/><path d="M8 8H16" stroke="url(#bookGlow)" stroke-width="1.5" stroke-linecap="round"/><path d="M8 11.5H14" stroke="url(#bookGlow)" stroke-width="1.5" stroke-linecap="round"/><circle cx="18" cy="4" r="1.2" fill="url(#bookGlow)" /><circle cx="3" cy="18" r="1" fill="url(#bookGlow)" /></svg>'} ${title} <span class="tag">${tag}</span></a>`;
  });
  list.innerHTML = html;
}
...
function renderHub(){
  ...
  Object.keys(TRACKS).forEach(id => {
    ...
    html += `<a class="hub-card" href="course.html?track=${id}">
      <div class="icon">${t.icon || '<svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bookGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3B82F6" /><stop offset="100%" stop-color="#1D4ED8" /></linearGradient><linearGradient id="bookGlow" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#60A5FA" /><stop offset="100%" stop-color="#93C5FD" /></linearGradient></defs><path d="M4 19.5C4 18.1193 5.11929 17 6.5 17H20V4H6.5C5.11929 4 4 5.11929 4 6.5V19.5Z" stroke="url(#bookGrad)" stroke-width="1.8" fill="url(#bookGrad)" fill-opacity="0.15" stroke-linejoin="round"/><path d="M6.5 17C5.11929 17 4 18.1193 4 19.5C4 20.8807 5.11929 22 6.5 22H20V17H6.5Z" stroke="url(#bookGrad)" stroke-width="1.8" stroke-linejoin="round"/><path d="M8 8H16" stroke="url(#bookGlow)" stroke-width="1.5" stroke-linecap="round"/><path d="M8 11.5H14" stroke="url(#bookGlow)" stroke-width="1.5" stroke-linecap="round"/><circle cx="18" cy="4" r="1.2" fill="url(#bookGlow)" /><circle cx="3" cy="18" r="1" fill="url(#bookGlow)" /></svg>'}</div>
      <h3>${title}</h3>
      <div class="meta">${count}</div>
      <div class="progress-bar-outer"><div class="progress-bar-inner" style="width:${pct}%"></div></div>
      ${completed ? `<div class="badge-row"><span class="badge-pill"><svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="coinGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#FFD700" /><stop offset="100%" stop-color="#FFA500" /></linearGradient><linearGradient id="glowGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#00F2FE" /><stop offset="100%" stop-color="#4FACFE" /></linearGradient></defs><circle cx="12" cy="12" r="9" stroke="url(#coinGrad)" stroke-width="2" fill="none" /><circle cx="12" cy="12" r="7" fill="url(#coinGrad)" fill-opacity="0.15" /><path d="M11 7H14C15.1046 7 16 7.89543 16 9C16 9.7958 15.5337 10.4828 14.8638 10.8038C15.5562 11.1098 16.0357 11.8021 16.0357 12.6071C16.0357 13.7117 15.1403 14.6071 14.0357 14.6071H11V7Z" stroke="url(#coinGrad)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 11H14.5" stroke="url(#coinGrad)" stroke-width="1.5" stroke-linecap="round"/><path d="M11 7V15" stroke="url(#coinGrad)" stroke-width="1.8" stroke-linecap="round"/><path d="M12.5 5.5V7" stroke="url(#coinGrad)" stroke-width="1.5" stroke-linecap="round"/><path d="M12.5 14.6V16.1" stroke="url(#coinGrad)" stroke-width="1.5" stroke-linecap="round"/><circle cx="19" cy="5" r="1" fill="url(#glowGrad)" /><circle cx="5" cy="19" r="1.5" fill="url(#glowGrad)" /></svg> ${currentLang==='en' ? 'Completed' : 'مكتمل'}</span></div>` : ''}
    </a>`;
  });
  grid.innerHTML = html;
}
...
function buildSidebar(){
  ...
  html += `<div class="course-title">${track.icon || '<svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="bookGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#3B82F6" /><stop offset="100%" stop-color="#1D4ED8" /></linearGradient><linearGradient id="bookGlow" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#60A5FA" /><stop offset="100%" stop-color="#93C5FD" /></linearGradient></defs><path d="M4 19.5C4 18.1193 5.11929 17 6.5 17H20V4H6.5C5.11929 4 4 5.11929 4 6.5V19.5Z" stroke="url(#bookGrad)" stroke-width="1.8" fill="url(#bookGrad)" fill-opacity="0.15" stroke-linejoin="round"/><path d="M6.5 17C5.11929 17 4 18.1193 4 19.5C4 20.8807 5.11929 22 6.5 22H20V17H6.5Z" stroke="url(#bookGrad)" stroke-width="1.8" stroke-linejoin="round"/><path d="M8 8H16" stroke="url(#bookGlow)" stroke-width="1.5" stroke-linecap="round"/><path d="M8 11.5H14" stroke="url(#bookGlow)" stroke-width="1.5" stroke-linecap="round"/><circle cx="18" cy="4" r="1.2" fill="url(#bookGlow)" /><circle cx="3" cy="18" r="1" fill="url(#bookGlow)" /></svg>'} ${trackTitle}</div>`;
    ...
    track.levels.forEach((level, li) => {
      ...
      html += `<div class="level-block ${openClass} ${lockedClass}" data-level="${li}">
        <div class="level-head" onclick="toggleLevel(${li})">
          <span>${unlocked ? '' : '<svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="secGrad" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#00F2FE" /><stop offset="100%" stop-color="#4FACFE" /></linearGradient></defs><path d="M12 22C12 22 20 18 20 12V5L12 2L4 5V12C4 18 12 22 12 22Z" stroke="url(#secGrad)" stroke-width="1.8" stroke-linejoin="round"/><rect x="9.5" y="11" width="5" height="4.5" rx="1" stroke="url(#secGrad)" stroke-width="1.5" fill="url(#secGrad)" fill-opacity="0.2"/><path d="M10.5 11V9.5C10.5 8.67157 11.1716 8 12 8C12.8284 8 13.5 8.67157 13.5 9.5V11" stroke="url(#secGrad)" stroke-width="1.5" stroke-linecap="round"/><circle cx="18" cy="5" r="1" fill="url(#secGrad)"/><circle cx="6" cy="18" r="1" fill="url(#secGrad)"/></svg> '}${levelName}</span>
      ...
      html += `<div class="lesson-link exam-link ${examDone ? 'done' : ''} ${examActive}" onclick="${unlocked ? `goToExam(${li})` : ''}">
          <span class="check">${examDone ? '✓' : ''}</span> <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="examGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#3B82F6" />
      <stop offset="100%" stop-color="#00F2FE" />
...
function renderLockedState(track){
  ...
  main.innerHTML = `
    <div class="locked-card">
      <div class="icon"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="lockGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#F59E0B" />
      <stop offset="100%" stop-color="#10B981" />
